...
1.Nenhuma stack trace interna seja exposta ao usuário final (segurança).

2.Todos os erros sigam um formato JSON padronizado.

3.Erros de validação do Zod sejam capturados e retornados com status 400 automaticamente.
